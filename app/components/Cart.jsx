    ...
    <div className="cart-details">
      ...
      {cartHasItems && (
        <CartSummary cost={cart.cost} currency={currency} layout={layout}>
          ...
          <p style={{fontFamily:'Arial', textTransform:'uppercase', fontSize:'10px', textAlign:'justify'}}>Shipments will be processed Monday-Friday. Orders placed after 5.00 PM (+7 GMT) will be processed in the next following business days.</p>
